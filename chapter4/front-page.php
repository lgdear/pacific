...
<?php
query_posts('posts_per_page=-1&post_type=page&orderby=menu_order&order=asc&post_parent=60');
if (have_posts()) : 
  $count = 1;
  while (have_posts()) : 
    the_post();
...
?>
        ...
        <section id="latest-columns">
          ...
          <span class="link-text archive-link"><a href="<?php echo get_term_link('column', 'category'); ?>">칼럼 목록</a></span>
...
?>
            <article class="column-article" >
              ...
              <span class="link-text"><a href="<?php the_permalink(); ?>">계속 읽기</a></span>
            </article>
<?php
    $count++;
  endwhile;
